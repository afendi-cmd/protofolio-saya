      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight text-brand-text">
            Muhammad <span className="text-brand-blue"> Ronal Afendi</span>.
          </h1>
          ...
          <div className="flex gap-5 items-center text-brand-text/60">
            <a href="https://github.com/afendi-cmd" target="_blank" rel="noopener noreferrer" className="hover:text-brand-purple transition-colors" title="GitHub">
            ...
            <a href="https://instagram.com/xenrovic" target="_blank" rel="noopener noreferrer" className="hover:text-brand-pink transition-colors" title="Instagram">
            ...
            <a href="https://linkedin.com/in/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-blue transition-colors" title="LinkedIn">
          ...
          >
            ...
            >
              ...
              <div className="absolute top-10 left-10 text-white">
                <h3 className="text-3xl font-black tracking-tight">Muhammad <span className="text-brand-amber"> Ronal Afendi</span></h3>
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between text-white p-4 bg-white/10 rounded-full shadow-lg backdrop-blur-md border border-white/10">
                <div className="flex items-center gap-3">
                  <img 
                    src="/images/nal.png" 
                    alt="Foto Profil xenrovic" 
                    className="w-10 h-10 rounded-full border border-white/20 object-cover"
                  />
                  <div>
                    <p className="text-base font-black text-white/90">@xenrovic</p> 
