            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:mronal.afendi04@gmail.com" className="text-lg font-black text-brand-text hover:text-brand-purple transition-colors">
                    mronal.afendi04@gmail.com
                  </a>
                </div>
              </div>
